...
输入为 journal 投影、单一 sequence 边界和当前物化领域表；输出为补齐 Loop、Mission、Context/Run、Curator、Directive、Fact 与 Portfolio 的完整 snapshot。
