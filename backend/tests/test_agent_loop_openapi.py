...
def test_agent_loop_openapi_surface_is_complete() -> None:
    ...
    expected = {
        ...
        "/desktop/api/agent-loops/{loop_id}/console": "get",
        "/desktop/api/agent-loops/{loop_id}/contexts/{context_id}/conversation": "get",
        "/desktop/api/agent-loops/{loop_id}/facts": "get",
