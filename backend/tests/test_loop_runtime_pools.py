...
from backend.app.desktop.agent_loop import AgentLoopService, ContextRunPool, LoopCoordinator, LoopCreateRequest, LoopKernel, PatrolDecisionIntent
from backend.app.desktop.agent_loop.models import AgentLoop, LoopDecision, LoopDirective, LoopRound, LoopWorkerRequest
...
def test_context_capacity_is_visible_and_pause_converges_work(tmp_path) -> None:
    async def run() -> None:
        ...
        try:
            ...
            pool = ContextRunPool(sessions, LoopCoordinator(sessions), object(), concurrency=1)
            ...
            ready_pool = ContextRunPool(sessions, RecordingCoordinator(), object(), concurrency=1)
