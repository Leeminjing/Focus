...
(function exposeFocusI18n(global) {
  ...
  const messages = Object.freeze({
    "zh-CN": Object.freeze({
      ...
      "settings.model_env_override": "环境变量 FOCUS_MODEL 正在覆盖默认模型：{name}；它优先于这里的默认选择。",
    ...
    "en-US": Object.freeze({
      ...
      "settings.model_env_override": "The FOCUS_MODEL environment variable overrides the default model: {name}; it takes precedence over the selection here.",
