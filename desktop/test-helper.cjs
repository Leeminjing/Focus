...
function createAppHarness(options = {}) {
  ...
  vm.runInContext(fs.readFileSync(require.resolve("./conversation-render.js"), "utf8"), context);
  vm.runInContext(fs.readFileSync(require.resolve("./conversation-view.js"), "utf8"), context);
